...
const Student =()=>{
    ...
    return(
        ...
        <div className='grid grid-cols-2 gap-40 px-20 pb-10'>
            <div className='border-2 rounded-3xl border-gray-300 w-fit'>
                <Image 
                src={kid}
                ...
                <div className='flex font-bold text-white rounded-full ml-20 bg-[#cbcb2c] mt-6 h-16 w-40 px-4 mb-10'>
                    <button>Read More</button>
                    <BsArrowRight className="ml-2 mt-6"/>
                </div>
            </div>
            <div className="pt-20" data-aos="slide-up">
                  ...
                  industry. We feature technology startups,<br/>
                   share tech news and discuss the “latest”<br/>
                    Javascript framework so that you can stay<br/>
                     ...
                     <div className='flex font-bold text-black rounded-full ml-20 bg-[#cbcb2c] mt-16 h-16 w-40 px-4 mb-10'>

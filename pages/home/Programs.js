...
const Programs =()=>{
    ...
    return(
        <div className="font-serif text-center lg:text-start text-black bg-white pb-10 overflow-x-hidden">
            ...
            <div className="grid lg:grid-cols-2 justify-center items-center px-32 gap-10 overflow-x-hidden">
                <div className="col-span-1 bg-[#03e9fa] overflow-x-hidden w-[500px] justify-center items-center rounded-xl" data-aos="slide-right">
                    <Image
                ...
                <div  className="col-span-1 bg-[#b0fa03] overflow-x-hidden w-[500px] rounded-xl" data-aos="slide-left">
                <Image

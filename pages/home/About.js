...
const About =()=>{
    ...
    return(
        <div className="text-black grid lg:grid-cols-2 gap-10 bg-white pt-20 font-serif overflow-x-hidden">
            <div className="lg:pl-48 flex justify-center pt-28" data-aos="zoom-in">
                <Image
                src={img1}
                alt="yenettacode.com"
                width={400}
            ...
            <div className="pr-20 pl-[-200px] flex flex-col items-center" data-aos="fade-left">
                <h1 className=" text-blue-700 my-3 font-bold">About Us</h1>
                <h1 className='font-bold text-3xl mb-2'>Equipping The Future</h1>
                <p className=" font-light mb-6 text-center">We're an educational company inspiring a new generation of thinkers.Our<br />
                goal is to provide learners with skills and ability to thrive in the digital world.</p>
                <div className=" px-4 grid justify-center gap-6 grid-cols-2 py-2">
                    <div>
                        <div className="flex">

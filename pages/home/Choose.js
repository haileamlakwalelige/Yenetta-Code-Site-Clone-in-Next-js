...
const Choose =()=>{
    ...
    return(
        <div className="text-black h-[100vh] bg-white font-serif top-48 pb-40 lg:pb-4">
            <div className="grid lg:grid-cols-2 gap-6 justify-center items-center text-center lg:pl-48 pt-32" data-aos="fade-right">

...
const Navbar =()=>{
    ...
    return(
        <div className=" pt-4 bg-white font-serif">
        ...
        <div className="pl-20">
            ...
            <div className="hidden lg:block pt-2 pl-[-100px] cursor-pointer">
            ...
            <div className="block lg:hidden pt-2 pl-[-100px] cursor-pointer">
            ...
            <div className="lg:pt-2 pl-10  lg:pl-[-100px] pt-6 pr-20">
